...
df_final <- df_normalized %>%
  dplyr::select(c("number_of_stations", "dist_to_nearest_mrt", "number_of_bus_stops", "dist_to_nearest_bus_stop"))
...
weights <- c(0.5528547252, 0.23523, 0.211915)  
...
print(c(cor_w_numstations,cor_w_numbus_stops,cor_w_mindist_stations,cor_w_mindist_bus_stops))
