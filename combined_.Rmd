...
## 7. Our Scoring Model
```{r}
final_score <- 0.379537954*df_select$footfall - 0.2202202202*df_select$dist_to_nearest_mall + 0.2202202202*df_select$accessibility_score -0.180418042*df_select$avg_median_price


final_scores <- as.data.frame(cbind(final_score, df_select$"Street_name")) %>%
  dplyr::arrange(desc(final_score)) %>%
  rename("Street_name"="V2") 
