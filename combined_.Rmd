...
number_of_mrt_near_street <-number_of_mrt_near_street %>%
  dplyr::select("Street_name", "Planning_Area", "number_of_stations", "dist_to_nearest_mrt", "station_name") %>%
...
## Obtaining an overall footfall score from PCA 
pca_scores_footfall <- pca_model_footfall$ind$coord[,0:3]
weights <- c(0.515, 0.27843,0.205814)  
footfall <- as.matrix(pca_scores_footfall) %*% weights  
...
##Default Weightages 
weight_footfall = 0.379537954
weight_dist_to_nearest_mall = 0.2202202202
weight_accessibility = 0.2202202202
weight_rental_price = 0.180418042

final_score <- weight_footfall*df_select$footfall - weight_dist_to_nearest_mall*df_select$dist_to_nearest_mall + weight_accessibility*df_select$accessibility_score - weight_rental_price*df_select$avg_median_price
